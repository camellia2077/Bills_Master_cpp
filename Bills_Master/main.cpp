...
void print_menu() {
    ...
    std::cout << "4. Query Yearly Summary and Export (md/tex)\n";
    std::cout << "5. Query Monthly Details and Export (md/tex)\n";
    std::cout << "6. Auto-Process Full Workflow (File or Directory)\n";
    std::cout << "7. Export All Reports from Database (md, tex, or both)\n";
    std::cout << "8. Version\n";
    std::cout << "9. Exit\n";
            ...
            switch (choice) {
                ...
                case 4:
                    { 
                        ...
                        std::string format_to_use = (trim(format_input) == "tex") ? "tex" : "md";
                ...
                case 7:
                    {
                        std::cout << "Enter format(s) (e.g., md, tex) [default: all]: ";
                        std::string format_input;
                        std::getline(std::cin, format_input);
