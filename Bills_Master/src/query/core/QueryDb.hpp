...
#include "query/plugins/common/PluginLoader.hpp" // 1. 包含新的通用加载器头文件
#include "query/plugins/month_formatters/IMonthReportFormatter.hpp" // 2. 包含接口定义
#include "query/plugins/year_formatters/IYearlyReportFormatter.hpp"  // 2. 包含接口定义
