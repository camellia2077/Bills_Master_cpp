...
import com.billstracer.android.ui.common.StatPill
import com.billstracer.android.ui.common.YearMonthDigitsRow
import com.billstracer.android.ui.common.manualRecordPeriodOrNull
import com.billstracer.android.ui.common.manualRecordPeriodValidationMessage

@Composable
internal fun RecordPane(
    state: BillsUiState,
    ...
    val existingMonths = listedPeriods?.periods.orEmpty()
        ...
        .distinct()
    val manualPeriodError = manualRecordPeriodValidationMessage(
        yearInput = state.recordPeriodYearInput,
        monthInput = state.recordPeriodMonthInput,
    )
    val isManualPeriodValid = manualRecordPeriodOrNull(
        yearInput = state.recordPeriodYearInput,
        monthInput = state.recordPeriodMonthInput,
    ) != null
    ...
    PaneContent(modifier = modifier) {
        ...
        SectionGroupCard(title = "Open Or Create Period") {
            ...
            YearMonthDigitsRow(
                ...
                enabled = !state.isInitializing && !state.isWorking,
                rowTag = "record_manual_period_field",
                yearFieldTag = "record_manual_period_year_field",
                monthFieldTag = "record_manual_period_month_field",
                separatorTag = "record_manual_period_separator",
                modifier = Modifier.fillMaxWidth(),
            )
...
@Composable
private fun RecordPreviewBlock(preview: RecordPreviewResult) {
    Column(
