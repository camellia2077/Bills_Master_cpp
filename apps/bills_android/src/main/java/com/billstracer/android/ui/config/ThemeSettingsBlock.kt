...
import com.billstracer.android.ui.theme.themeColorDisplayOrder
import com.billstracer.android.ui.theme.themeColorPreview
...
internal fun ThemeSettingsBlock(
    ...
    Column(
        ...
        Text(
            text = "Preview shows the selected custom brand color expanded into Material 3 light/dark surfaces.",
            style = MaterialTheme.typography.bodySmall,
            fontFamily = FontFamily.Monospace,
        )
        Text(
...
private fun ThemeColorOption(
    ...
    Box(
        modifier = Modifier
            ...
            .testTag("theme_color_${color.name.lowercase()}")
            .selectable(
                selected = isSelected,
