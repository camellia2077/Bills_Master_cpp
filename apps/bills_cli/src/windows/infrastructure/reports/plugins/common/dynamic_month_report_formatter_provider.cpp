#include "windows/infrastructure/reports/plugins/common/dynamic_month_report_formatter_provider.hpp"

#include <algorithm>
#include <cctype>
#include <string>

#include "reports/plugins/month_formatters/month_md/month_md_format.hpp"
