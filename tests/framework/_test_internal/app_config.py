...
RUNTIME_BASE_DIR = (
    _resolve_config_path(_runtime_base_raw) if _runtime_base_raw else ""
)
RUNTIME_RUN_ID = str(RUNTIME.get("run_id", "")).strip()

_runtime_output_raw = RUNTIME.get("output_dir", "")
RUNTIME_OUTPUT_DIR = (
    _resolve_config_path(_runtime_output_raw) if _runtime_output_raw else ""
)

_runtime_summary_raw = RUNTIME.get("summary_path", "")
RUNTIME_SUMMARY_PATH = (
    _resolve_config_path(_runtime_summary_raw) if _runtime_summary_raw else ""
)
