...
import bill.core.record_editor.service;
...
using bills::core::modules::record_editor::RecordEditorService;
...
[[maybe_unused]] auto kQueryRangeEntry = &QueryService::QueryRange;
[[maybe_unused]] auto kRenderEntry = &ReportRenderService::Render;
[[maybe_unused]] auto kAssemblerEntry = &StandardReportAssembler::FromRange;
...
[[maybe_unused]] auto kRecordEditorEntry = &RecordEditorService::Parse;
