...
#include "windows/infrastructure/adapters/config/json_config_provider.hpp"
#include "windows/infrastructure/adapters/db/sqlite_bill_repository.hpp"
#include "windows/infrastructure/adapters/io/file_bill_content_reader.hpp"
#include "windows/infrastructure/adapters/io/file_bill_file_enumerator.hpp"
...
{
  m_config_provider = std::make_unique<JsonConfigProvider>();
  ...
  m_file_enumerator = std::make_unique<FileBillFileEnumerator>();
