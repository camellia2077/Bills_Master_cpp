...
#include "month_typ_format.hpp"
#include "windows/infrastructure/reports/plugins/common/plugin_export.hpp"
#include <sstream>
#include <iomanip>
#include <vector>
#include <string>
...
extern "C" {
REPORT_PLUGIN_EXPORT IMonthReportFormatter* create_typ_month_formatter() {
