...
- Build Windows CLI:
  - `python scripts/verify.py bills-build`
- Build + run CLI test suite:
  - `python scripts/verify.py bills`
- Build `bills_core` shared library:
  - `python scripts/verify.py core-build`
- Run `bills_core` C ABI smoke tests:
  - `python scripts/verify.py core-abi`
