...
- `docs/modules/core/architecture.md`
...
- `docs/modules/core/c_abi_boundary.md`
- `docs/modules/core/c_abi_schema_draft.md`
- `docs/modules/core/standard_report_json_schema_v1.md`
- `docs/modules/core/legacy_pipeline_sunset_plan.md`
- `docs/modules/core/md_json_render_phase0_phase1.md`
