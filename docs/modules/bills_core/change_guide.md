...
| 调整模板生成、记录预览、preflight import | `libs/bills_core/src/record_template/record_template_service.cpp` | `libs/bills_core/src/record_template/import_preflight_service.cpp` |
| 调整 ABI 请求/响应结构 | `libs/bills_core/src/abi/bills_core_abi.cpp` | `docs/modules/bills_core/abi_contract.md` |
